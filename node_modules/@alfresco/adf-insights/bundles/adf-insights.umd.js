    ...
    ***************************************************************************** */
         ...
         */
            function (reportId, name) {
                ...
                return rxjs.from(this.apiService.getInstance().activiti.reportApi.updateReport(reportId, name))
                    .pipe(operators.map(function () { return _this.logService.info('upload'); }), operators.catchError(function (err) { return _this.handleError(err); }));
            };
        /**
         * @param {?} reportId
         * @param {?} paramsQuery
    ...
    var AnalyticsReportListComponent = /** @class */ (function () {
        function AnalyticsReportListComponent(analyticsService) {
            ...
            this.error = new core.EventEmitter();
            this.reports = [];
            this.report$ = new rxjs.Observable(function (observer) { return _this.reportObserver = observer; })
