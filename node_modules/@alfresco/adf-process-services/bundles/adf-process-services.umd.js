(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@alfresco/js-api'), require('@angular/material/dialog'), require('@alfresco/adf-content-services'), require('@angular/material/core'), require('moment-es6'), require('rxjs'), require('rxjs/operators'), require('@angular/material'), require('@angular/flex-layout'), require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('@alfresco/adf-core')) :
    typeof define === 'function' && define.amd ? define('@alfresco/adf-process-services', ['exports', '@alfresco/js-api', '@angular/material/dialog', '@alfresco/adf-content-services', '@angular/material/core', 'moment-es6', 'rxjs', 'rxjs/operators', '@angular/material', '@angular/flex-layout', '@angular/common', '@angular/core', '@angular/forms', '@alfresco/adf-core'], factory) :
    (factory((global.alfresco = global.alfresco || {}, global.alfresco['adf-process-services'] = {}),global['@alfresco/js-ap'],global.ng.material.dialog,global['@alfresco/adf-content-services'],global['@angular/material/core'],global['moment-es6'],global.rxjs,global.rxjs.operators,global['@angular/material'],global['@angular/flex-layout'],global.ng.common,global.ng.core,global.ng.forms,global['@alfresco/adf-core']));
}(this, (function (exports,jsApi,i1,adfContentServices,core,moment$1,rxjs,operators,material,flexLayout,common,i0,forms,i1$1) { 'use strict';
         ...
         */
            function (appId) {
                ...
                return new rxjs.Observable(function (observer) {
                    rxjs.forkJoin(runningObservable, completedObservable, allObservable).subscribe(function (res) {
                        /** @type {?} */
                        var filters = [];
    ...
    var ProcessService = /** @class */ (function () {
         ...
         */
            function (processInstanceId, state) {
                ...
                return rxjs.from(this.alfrescoApiService.getInstance().activiti.taskApi.listTasks(taskOpts))
                    .pipe(operators.map(this.extractData), operators.map(function (tasks) {
         ...
         */
            function (processInstanceId, variables) {
                var _this = this;
                return rxjs.from(this.alfrescoApiService.getInstance().activiti.processInstanceVariablesApi.createOrUpdateProcessInstanceVariables(processInstanceId, variables)).pipe(operators.catchError(function (err) { return _this.handleProcessError(err); }));
            };
        /**
    ...
    ***************************************************************************** */
         ...
         */
            function (taskId, updated) {
                ...
                return rxjs.from(this.apiService.taskApi.updateTask(taskId, updated))
                    .pipe(operators.map(function (result) { return ( /** @type {?} */(result)); }), operators.catchError(function (err) { return _this.handleError(err); }));
            };
        /**
         ...
         */
            function (taskId) {
                ...
                return rxjs.from(this.apiService.taskApi.getTaskAuditPdf(taskId))
                    .pipe(operators.map(function (data) { return ( /** @type {?} */(data)); }), operators.catchError(function (err) { return _this.handleError(err); }));
            };
        /**
    ...
    var TaskListComponent = /** @class */ (function (_super) {
        ...
        function TaskListComponent(taskListService, appConfigService, userPreferences) {
            ...
            _this.userPreferences.select(i1$1.UserPreferenceValues.PaginationSize).subscribe(function (pageSize) {
                _this.size = pageSize;
            });
    ...
    var TaskFilterService = /** @class */ (function () {
         ...
         */
            function (appId) {
                ...
                return new rxjs.Observable(function (observer) {
                    rxjs.forkJoin(involvedObservable, myTaskObservable, queuedObservable, completeObservable).subscribe(function (res) {
                        /** @type {?} */
                        var filters = [];
                        res.forEach(function (filter) {
     ...
     * @suppress {checkTypes,extraRequire,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var ɵ0$1 = i1$1.MOMENT_DATE_FORMATS;
    var StartTaskComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                this.userPreferencesService.select(i1$1.UserPreferenceValues.Locale).subscribe(function (locale) {
         ...
         */
            function () {
                ...
                this.taskForm = this.formBuilder.group({
                    name: new forms.FormControl(this.taskDetailsModel.name, [forms.Validators.required, forms.Validators.maxLength(this.maxTaskNameLength)]),
         ...
         */
            function () {
                ...
                this.taskService.createNewTask(this.taskDetailsModel)
                    .pipe(operators.switchMap(function (createRes) {
                    return _this.attachForm(createRes.id, _this.taskDetailsModel.formKey).pipe(operators.defaultIfEmpty(createRes), operators.switchMap(function (attachRes) {
         ...
         */
            function () {
                ...
                this.filteredProcesses = this.processDefinitionInput.valueChanges
                    .pipe(operators.map(function (value) { return _this._filter(value); }));
            };
        /**
         * @param {?} changes
         * @return {?}
