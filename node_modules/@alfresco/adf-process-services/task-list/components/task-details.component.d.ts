...
export declare class TaskDetailsComponent implements OnInit, OnChanges {
    ...
    data: any;
    constructor(taskListService: TaskListService, authService: AuthenticationService, peopleProcessService: PeopleProcessService, formRenderingService: FormRenderingService, logService: LogService, cardViewUpdateService: CardViewUpdateService, dialog: MatDialog);
    ngOnInit(): void;
