...
export declare class DocumentListComponent implements OnInit, OnChanges, OnDestroy, AfterContentInit, PaginatedComponent, NavigableComponentInterface {
    ...
    constructor(documentListService: DocumentListService, ngZone: NgZone, elementRef: ElementRef, appConfig: AppConfigService, userPreferencesService: UserPreferencesService, customResourcesService: CustomResourcesService, contentService: ContentService, thumbnailService: ThumbnailService, alfrescoApiService: AlfrescoApiService);
