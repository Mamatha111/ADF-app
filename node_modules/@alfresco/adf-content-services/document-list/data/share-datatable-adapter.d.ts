...
export declare class ShareDataTableAdapter implements DataTableAdapter {
    ...
    selectedRow: DataRow;
    sortingMode: string;
    constructor(documentListService: DocumentListService, thumbnailService: ThumbnailService, contentService: ContentService, schema?: DataColumn[], sorting?: DataSorting, sortingMode?: string);
    ...
    private sortRows;
    loadPage(nodePaging: NodePaging, merge?: boolean): void;
}
