...
import { AlfrescoApiService, AuthenticationService, ContentService, LogService, ThumbnailService, NodesApiService, CoreModule, TranslationService, ObjectDataTableAdapter, SearchService, FileModel, FileUploadStatus, UploadService, EXTENDIBLE_COMPONENT, FileUtils, AllowableOperationsEnum, NotificationService, BaseEvent, DataSorting, ObjectUtils, CardViewUpdateService, MOMENT_DATE_FORMATS, UserPreferenceValues, MomentDateAdapter, UserPreferencesService, SitesService, AppConfigService, TRANSLATION_PROVIDER, CardViewTextItemModel, CardViewIntItemModel, CardViewFloatItemModel, CardViewDateItemModel, CardViewDatetimeItemModel, CardViewBoolItemModel, FileSizePipe, HighlightDirective, InfinitePaginationComponent, SharedLinksApiService, RenditionsService, SearchConfigurationService, DisplayMode, ObjectDataColumn, DataColumnListComponent, CustomLoadingContentTemplateDirective, CustomNoPermissionTemplateDirective, CustomEmptyContentTemplateDirective, NodeDownloadDirective } from '@alfresco/adf-core';
import { NgModule, Injectable, Directive, ElementRef, Renderer2, HostListener, Input, Component, ViewEncapsulation, ViewChild, ViewContainerRef, ComponentFactoryResolver, Inject, EventEmitter, Output, Optional, NgZone, Pipe, ChangeDetectionStrategy, ContentChild, defineInjectable, inject, forwardRef, ChangeDetectorRef, ViewChildren, TemplateRef } from '@angular/core';
    ...
    ngOnChanges(changes) {
        ...
        if (this.data) {
            if (changes.node && changes.node.currentValue) {
                /** @type {?} */
                let merge$$1 = this._pagination ? this._pagination.merge : false;
