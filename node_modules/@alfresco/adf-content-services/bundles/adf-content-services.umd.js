(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/keycodes'), require('@angular/material/core'), require('@angular/animations'), require('@mat-datetimepicker/core'), require('@mat-datetimepicker/moment'), require('@angular/flex-layout'), require('@angular/material/dialog'), require('moment-es6'), require('@angular/material'), require('@angular/forms'), require('@angular/common'), require('@ngx-translate/core'), require('rxjs'), require('@angular/cdk/tree'), require('@alfresco/adf-core'), require('@angular/core'), require('@alfresco/js-api'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@alfresco/adf-content-services', ['exports', '@angular/cdk/keycodes', '@angular/material/core', '@angular/animations', '@mat-datetimepicker/core', '@mat-datetimepicker/moment', '@angular/flex-layout', '@angular/material/dialog', 'moment-es6', '@angular/material', '@angular/forms', '@angular/common', '@ngx-translate/core', 'rxjs', '@angular/cdk/tree', '@alfresco/adf-core', '@angular/core', '@alfresco/js-api', 'rxjs/operators'], factory) :
    (factory((global.alfresco = global.alfresco || {}, global.alfresco['adf-content-services'] = {}),global.ng.cdk.keycodes,global['@angular/material/core'],global['@angular/animations'],global['@mat-datetimepicker/core'],global['@mat-datetimepicker/moment'],global['@angular/flex-layout'],global.ng.material.dialog,global['moment-es6'],global['@angular/material'],global.ng.forms,global.ng.common,global['@ngx-translate/core'],global.rxjs,global.ng.cdk.tree,global['@alfresco/adf-core'],global.ng.core,global['@alfresco/js-ap'],global.rxjs.operators));
}(this, (function (exports,keycodes,core,animations,core$1,moment$1,flexLayout,i2,moment$2,material,forms,common,core$2,rxjs,tree,i1,i0,jsApi,operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var DocumentListService = /** @class */ (function () {
         ...
         */
            function (folder, opts, includeFields) {
                ...
                return rxjs.from(this.apiService.getInstance().nodes.getNodeChildren(rootNodeId, params)).pipe(operators.catchError(function (err) { return _this.handleError(err); }));
            };
        /**
         ...
         */
            function (nodeId, includeFields) {
                ...
                return rxjs.from(this.apiService.getInstance().nodes.getNode(nodeId, opts)).pipe(operators.catchError(function (err) { return _this.handleError(err); }));
            };
        /**
    ...
    var ContentNodeDialogService = /** @class */ (function () {
        ...
        /** @nocollapse */ ContentNodeDialogService.ngInjectableDef = i0.defineInjectable({ factory: function ContentNodeDialogService_Factory() { return new ContentNodeDialogService(i0.inject(i2.MatDialog), i0.inject(i1.ContentService), i0.inject(DocumentListService), i0.inject(i1.SitesService), i0.inject(i1.TranslationService)); }, token: ContentNodeDialogService, providedIn: "root" });
    ...
    var DocumentListComponent = /** @class */ (function () {
        function DocumentListComponent(documentListService, ngZone, elementRef, appConfig, userPreferencesService, customResourcesService, contentService, thumbnailService, alfrescoApiService) {
            ...
            this.subscriptions = [];
            this.rowMenuCache = {};
            this.userPreferencesService.select(i1.UserPreferenceValues.PaginationSize).subscribe(function (pagSize) {
    ...
    var NodeActionsService = /** @class */ (function () {
         ...
         */
            function (node) {
                new i1.NodeDownloadDirective(this.apiService, this.dialog)
                    .downloadNode(node);
            };
        /**
         * Copy content node
        ...
        /** @nocollapse */ NodeActionsService.ngInjectableDef = i0.defineInjectable({ factory: function NodeActionsService_Factory() { return new NodeActionsService(i0.inject(ContentNodeDialogService), i0.inject(i2.MatDialog), i0.inject(i1.ContentService), i0.inject(DocumentListService), i0.inject(i1.AlfrescoApiService), i0.inject(i2.MatDialog)); }, token: NodeActionsService, providedIn: "root" });
    ...
    var FolderActionsService = /** @class */ (function () {
        ...
        /** @nocollapse */ FolderActionsService.ngInjectableDef = i0.defineInjectable({ factory: function FolderActionsService_Factory() { return new FolderActionsService(i0.inject(NodeActionsService), i0.inject(DocumentListService), i0.inject(i1.ContentService), i0.inject(i1.TranslationService)); }, token: FolderActionsService, providedIn: "root" });
    ...
    var LibraryRoleColumnComponent = /** @class */ (function () {
        function LibraryRoleColumnComponent() {
        }
        /**
         * @return {?}
         */
         ...
         */
            function () {
                ...
                var deletedFiles = this.files
                    .filter(function (file) { return file.status === i1.FileUploadStatus.Complete; })
                    .map(function (file) { return _this.deleteNode(file); });
                rxjs.forkJoin.apply(void 0, __spread(deletedFiles)).subscribe(function (files) {
                    var _a;
                    /** @type {?} */
                    var errors = files
                        .filter(function (file) { return file.status === i1.FileUploadStatus.Error; });
                    if (errors.length) {
         ...
         */
            function () {
                return this.files.filter(function (item) {
                    if (item.status === i1.FileUploadStatus.Pending ||
                        item.status === i1.FileUploadStatus.Progress ||
                        item.status === i1.FileUploadStatus.Starting) {
                        return item;
                    }
                });
            };
         ...
         */
            function () {
                ...
                if (this.rootFolderId) {
                    ...
                    this.contentService.getNode(this.rootFolderId, opts).subscribe(function (res) { return _this.permissionValue.next(_this.nodeHasPermission(res.entry, i1.AllowableOperationsEnum.CREATE)); }, function (error) { return _this.error.emit(error); });
                }
            };
        /**
         * @param {?} node
    ...
    var UploadDragAreaComponent = /** @class */ (function (_super) {
         ...
         */
            function (event) {
                ...
                event.preventDefault();
                /** @type {?} */
                var isAllowed = this.contentService.hasAllowableOperations(event.detail.data.obj.entry, i1.AllowableOperationsEnum.CREATE);
                if (isAllowed) {
                    /** @type {?} */
         ...
         */
            function () {
                ...
                if (this.queryBuilder) {
                    this.queryBuilder.executed.pipe(operators.takeWhile(function () { return _this.isAlive; })).subscribe(function (resultSetPaging) {
         ...
         */
            function (context) {
                ...
                if (!this.responseFacets) {
                    ...
                    this.responseFacets = responseFacetFields.concat.apply(responseFacetFields, __spread(responseGroupedFacetQueries));
                }
                else {
         ...
         */
            function (context) {
                ...
                return configFacetFields.map(function (field) {
                    ...
                    return ( /** @type {?} */(__assign({}, field, { type: responseField.type, label: field.label, pageSize: field.pageSize | _this.DEFAULT_PAGE_SIZE, currentPageSize: field.pageSize | _this.DEFAULT_PAGE_SIZE, buckets: bucketList })));
                });
            };
        /**
         * @private
    ...
    var SearchDateRangeComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                this.userPreferencesService.select(i1.UserPreferenceValues.Locale).subscribe(function (locale) {
    ...
    var VersionManagerComponent = /** @class */ (function () {
        ...
        VersionManagerComponent.decorators = [
            { type: i0.Component, args: [{
                        ...
                        encapsulation: i0.ViewEncapsulation.None,
                        styles: [".adf-button.adf-upload-new-version{box-shadow:none;width:100%;height:175px;float:left;position:relative}.adf-new-version-uploader-container{border-bottom:1px solid #d8d8d8;padding:16px 0;width:100%;height:0%;position:relative;display:hidden;float:left!important}.adf-new-version-container{height:inherit;overflow:hidden}.adf-version-list-table,.adf-version-upload-table{width:100%}.adf-version-list{width:100%!important;float:left!important}"]
                    }] }
        ];
        /** @nocollapse */
    ...
    var ContentNodeSelectorPanelComponent = /** @class */ (function () {
        ...
        ContentNodeSelectorPanelComponent.propDecorators = {
            ...
            highlighter: [{ type: i0.ViewChild, args: [i1.HighlightDirective,] }],
            infinitePaginationComponent: [{ type: i0.ViewChild, args: [i1.InfinitePaginationComponent,] }]
        };
         ...
         */
            function () {
                ...
                this.form.controls['title'].valueChanges
                    .pipe(operators.debounceTime(300), operators.mergeMap(function (title) { return _this.checkLibraryNameExists(title); }, function (title) { return title; }), operators.takeUntil(this.onDestroy$))
                ...
                return function (control) {
                    ...
                    return new Promise(function (resolve) {
                        timer = setTimeout(function () {
                            return rxjs.from(_this.alfrescoApiService.sitesApi.getSite(control.value)).subscribe(function () { return resolve({ message: 'LIBRARY.ERRORS.EXISTENT_SITE' }); }, function () { return resolve(null); });
                        }, 300);
                    });
                };
            };
         ...
         */
            function (property, propertyValues) {
                ...
                switch (property.dataType) {
                    ...
                    case D_INT:
                    case D_LONG:
                        cardViewItemProperty = new i1.CardViewIntItemModel(propertyDefinition);
                        break;
                    case D_FLOAT:
                    case D_DOUBLE:
                        cardViewItemProperty = new i1.CardViewFloatItemModel(propertyDefinition);
                        break;
                    case D_DATE:
                        cardViewItemProperty = new i1.CardViewDateItemModel(propertyDefinition);
                        break;
                    case D_DATETIME:
                        cardViewItemProperty = new i1.CardViewDatetimeItemModel(propertyDefinition);
                        break;
                    case D_BOOLEAN:
            ...
            function (node, presetName) {
                ...
                if (node.aspectNames) {
                    ...
                    if (groupNames.length > 0) {
                        groupedProperties = this.propertyDescriptorsService.load(groupNames).pipe(operators.map(function (groups) { return config_1.reorganiseByConfig(groups); }), operators.map(function (groups) { return _this.setTitleToNameIfNotSet(groups); }), operators.map(function (groups) { return _this.propertyGroupTranslatorService.translateToCardViewGroups(groups, node.properties); }));
                    }
                }
    ...
    var NodePermissionDialogService = /** @class */ (function () {
        ...
        /** @nocollapse */ NodePermissionDialogService.ngInjectableDef = i0.defineInjectable({ factory: function NodePermissionDialogService_Factory() { return new NodePermissionDialogService(i0.inject(i2.MatDialog), i0.inject(NodePermissionService), i0.inject(i1.ContentService)); }, token: NodePermissionDialogService, providedIn: "root" });
    ...
    exports.ɵn = TreeViewComponent;
    exports.ɵo = TreeViewService;
    exports.ɵm = TreeViewModule;
